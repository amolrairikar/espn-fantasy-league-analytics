...
function Login({ onLoginSuccess }: LoginProps) {
  ...
  const [loginFormErrors, setLoginFormErrors] = useState<{ leagueId?: string; platform?: string; privacy?: string }>({});
  ...
  return (
    <div>
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          <CardTitle>
            Provide your league information
          </CardTitle>
          <CardDescription>
      ...
      <Dialog open={showOnboardDialog} onOpenChange={setShowOnboardDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Fill in your fantasy league information to onboard your league.
              Instructions on how to find your ESPN cookies can be found <a href="https://www.espn.com" target="_blank" className="text-blue-600">here</a>.
            </DialogDescription>
          </DialogHeader>
          <Card className="w-full max-w-md mx-auto">
            <CardContent className="grid gap-6">
